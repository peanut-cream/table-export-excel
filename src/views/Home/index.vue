...
const fieldList = ref([
  ...
  { prop: "box_number", name: "箱数", enName: "Ctn Qty", width: 180 },
  { prop: "ctn", name: "每箱数量", enName: "Pkg/ctn", width: 180 },
  { prop: "total", name: "合计数量", enName: "Ttlpkg Qty", width: 180 },
  { prop: "price", name: "单价", enName: "U.Price", width: 180 },
  { prop: "sub_price", name: "小计金额", enName: "Sub Total", width: 180 },
  {
    prop: "specifications",
    name: "单箱规格(m³)",
